...
echo "Cortex"
sed -e "s|AAAAA|../Data/Cortex/Data.zst|g" Templates/Halko_3iter_Template > TMP_Halko_Cortex.sh
OUT="../Data/Cortex/Halko_3iter"
mkdir -p $OUT
...
LOG="log/Cortex_Halko_3iter.out"
...
echo "Brain"
sed -e "s|AAAAA|../Data/Brain/1M_neurons_filtered_gene_bc_matrices_h5.zst|g" Templates/Halko_3iter_Template > TMP_Halko_Brain.sh
