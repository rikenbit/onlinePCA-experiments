...
echo "PBMCs"
OUT="../Data/PBMCs/Halko_3iter"
LOG="log/PBMCs_Halko_3iter.out"
mkdir -p $OUT

sed -e "s|AAAAA|../Data/PBMCs/Data.zst|g" Templates/Halko_3iter_Template > TMP_Halko_PBMCs.sh
...
echo "Pancreas"
OUT="../Data/Pancreas/Halko_3iter"
LOG="log/Pancreas_Halko_3iter.out"
mkdir -p $OUT

sed -e "s|AAAAA|../Data/Pancreas/Data.zst|g" Templates/Halko_3iter_Template > TMP_Halko_Pancreas.sh
...
OUT="../Data/BrainSpinalCord/Halko_3iter"
LOG="log/BrainSpinalCord_Halko_3iter.out"
mkdir -p $OUT

sed -e "s|AAAAA|../Data/BrainSpinalCord/Data.zst|g" Templates/Halko_3iter_Template > TMP_Halko_BrainSpinalCord.sh
...
echo "Brain"
OUT="../Data/Brain/Halko_3iter"
LOG="log/Brain_Halko_3iter.out"
mkdir -p $OUT

sed -e "s|AAAAA|../Data/1M_neurons_filtered_gene_bc_matrices_h5.zst|g" Templates/Halko_3iter_Template > TMP_Halko_Brain.sh
