...
echo "PBMCs"
OUT="../Data/PBMCs/Halko_2iter"
LOG="log/PBMCs_Halko_2iter.out"
mkdir -p $OUT

sed -e "s|AAAAA|../Data/PBMCs/Data.zst|g" Templates/Halko_2iter_Template > TMP_Halko_PBMCs.sh
...
OUT="../Data/BrainSpinalCord/Halko_2iter"
LOG="log/BrainSpinalCord_Halko_2iter.out"
mkdir -p $OUT

sed -e "s|AAAAA|../Data/BrainSpinalCord/Data.zst|g" Templates/Halko_2iter_Template > TMP_Halko_BrainSpinalCord.sh
...
sed -e "s|AAAAA|../Data/1M_neurons_filtered_gene_bc_matrices_h5.zst|g" Templates/Halko_2iter_Template > TMP_Halko_Brain.sh
